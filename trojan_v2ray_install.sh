...
function removeNginx(){
    ...
    if [ "$osRelease" == "centos" ]; then
        ...
        apt-get remove --purge nginx nginx-full nginx-commons
        apt purge nginx* -y
        apt purge caddy* -y
    fi
...
function start_menu(){
    ...
    green " =================================================="
    green " Trojan Trojan-go V2ray 一键安装脚本 2020-11-28 更新.  系统支持：centos7+ / debian9+ / ubuntu16.04+"
